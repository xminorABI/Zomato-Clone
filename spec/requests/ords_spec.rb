...
RSpec.describe "Ords", type: :request do
  describe "GET /index ords" do
    it " get ords page" do
      ...
      get '/ords', params:{restaurant_id: restaurant.id, accept:["1","2"], quantity:["1","","5"]}
  ...
  describe "Post /create ords" do
    it " get ords page" do
      ...
      post '/ords', params:{restaurant_id: restaurant.id, menu_arr:"1 4", quantity_arr:"1 50", street:"Test", city:"Test", pincode:"700112"}
