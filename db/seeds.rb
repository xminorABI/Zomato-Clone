...
@user = User.create(username: 'Admin', email: 'admin@gmail.com', password: 'Admin', password_confirmation: 'Admin',
                    isadmin: true)
@user.update(isadmin: true, password: 'Admin', password_confirmation: 'Admin')
Restaurant.create(name: 'Restaurant1', category: 'Fast-Food', resturant_type: 'Dine In', latitude: 22.5596,
                  longitude: 88.35046)
Restaurant.create(name: 'Restaurant2', category: 'Chinese', resturant_type: 'Dine In', latitude: 22.5014,
                  longitude: 88.3616)
Restaurant.create(name: 'Restaurant3', category: 'Luxary', resturant_type: 'Dine In', latitude: 22.5481,
                  longitude: 88.3992)
Restaurant.create(name: 'Restaurant4', category: 'North-Indian', resturant_type: 'Dine In', latitude: 22.7013711863,
                  longitude: 88.3747081393)
Restaurant.create(name: 'Restaurant5', category: 'Continental', resturant_type: 'Dine In', latitude: 22.51704,
                  longitude: 88.36709)
Restaurant.create(name: 'Restaurant6', category: 'South-Indian', resturant_type: 'Dine In', latitude: 22.7008,
                  longitude: 88.37783)
